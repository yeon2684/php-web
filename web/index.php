...
             <p class="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-90 animate-fade-in">Add commentMore actions
                Delivering innovative, sustainable, and high-quality construction solutions for a better future.
            </p>
            <a href="projects.php" class="btn-primary bg-yellow-500 text-white hover:bg-yellow-600">Add commentMore actions
                VIEW OUR PROJECTS
...
@@ -57,28 +52,27 @@ class="absolute inset-0 w-full h-full object-cover opacity-30">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-lg text-gray-600 mb-4">
                    JJANG Building Solutions is a leading construction firm dedicated to delivering excellence. With a focus on innovation and sustainability, we bring your visions to life.
                </p>
